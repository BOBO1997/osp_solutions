...
from kagome_trotter.circuits_1d_path import gate_path_conventional, gate_path_triangle
...
for num_steps in num_steps_list:
    ...
    matrix_path_triangle = \
        qi.Operator(gate_path_triangle(num_qubits=num_qubits,
    ...
    print('process fidelity between proposed and U_Heisenberg = {:.4f}'.format(fidelities_triangle[-1]))
    print()
    print('trace norm between conventional and U_Heisenberg = {:.4f}'.format(distances_trace_conventional[-1]))
    print('trace norm between proposed and U_Heisenberg = {:.4f}'.format(distances_trace_triangle[-1]))
    print("time:", t2 - t1)
    print()
...
for num_steps in num_steps_list:
    ...
    qc_triangle.compose(gate_path_triangle(num_qubits=num_qubits,
                                          num_steps=num_steps // 2, ###!
                                          dt=2 * time_evolution / num_steps, ###!
                                          type_H_eff="exact",
                                          to_instruction=False,
    ...
    print("number of CNOT gates in proposed:", nums_cnot_triangle[-1])
    print("time:", t2 - t1)
    print()
